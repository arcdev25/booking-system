      ...
      <div className="listingSection__wrap overflow-hidden">
        ...
        <div className="listingSection__wrap__DayPickerRangeController flow-root">
          <div className="-mx-4 sm:mx-auto xl:mx-[-22px]">
            <ReactDatePicker
              selected={selectedDate.startDate ? moment(selectedDate.startDate).toDate() : null}
              ...
              startDate={selectedDate.startDate ? moment(selectedDate.startDate).toDate() : null}
              endDate={selectedDate.endDate ? moment(selectedDate.endDate).toDate() : null}
              selectsRange
              inline
              minDate={new Date()}
              monthsShown={windowSize.width < 1280 ? 1 : 2}
              calendarClassName="nc-listing-datepicker"
            />
          </div>
        </div>
